    ...
    <section id="grand-finale" className="py-20" style={{ background: 'linear-gradient(135deg, #fdf8ef 0%, #f9f0dd 30%, #fdf8ef 60%, #faf3e3 100%)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="font-playfair text-3xl sm:text-4xl md:text-5xl font-bold mb-4" style={{ backgroundImage: 'linear-gradient(135deg, #8b6914 0%, #c9a84c 40%, #8b6914 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
            Grand Finale
          </h2>
          ...
          <p className="text-base sm:text-lg max-w-3xl mx-auto px-2" style={{ color: '#6b5520' }}>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="flex justify-center">
            <div className="w-full max-w-md rounded-xl overflow-hidden" style={{ border: '2px solid #c9a84c44' }}>
              <blockquote
          ...
          <div>
            <p className="text-sm uppercase tracking-widest mb-3 text-center md:text-left" style={{ color: '#8b6914' }}>Our Campaign Video (Click to watch)</p>
